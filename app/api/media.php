...
class media extends AWS_CONTROLLER
{
...
//            $rule_action['actions'][] = 'media_users';
//            $rule_action['actions'][] = 'media_posts';
    ...
    public function media_users_action()
    {
        ...
        $users = array_values($this->model('account')->get_users_list('group_id = 101', implode(',', $limit), $attrib = true, $exclude_self = false));
    ...
    public function media_posts_action()
    {
        $per_page = get_setting('contents_per_page');
        ...
        $posts_list = $this->model('myapi')->get_posts_list_by_uid(null, true, false, null, $_GET['page'], $per_page, $_GET['sort_type'], null, $category_info['id'], $_GET['answer_count'], $_GET['day'], $_GET['is_recommend']);

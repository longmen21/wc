...
//        }
    ...
    public function index_action()
    {
        ...
        if (strlen($article_info['url']) == 0) {
            $article_info['url'] = 'http://' . $_SERVER['HTTP_HOST'] . '/article/' . $article_info['id'];
        }
        ...
        if ($article_info['user_info']) {
            ...
            if ($this->model('follow')->user_follow_check($this->user_id, $article_info['user_info']['uid'])) {
                $article_info['user_info']['has_focus'] = 1;
            } else {
                $article_info['user_info']['has_focus'] = 0;
            }
        }
        ...
        //是否收藏
        $article_info['is_favorite'] = $this->model('myapi')->has_favorite_article($this->user_id, $article_info['id']);
